...
We applied a targeted B-Tree composite index (`@@index([companyId, date])`) to the Prisma schema and introduced Upstash Redis as an in-memory response cache with a 300-second TTL.
